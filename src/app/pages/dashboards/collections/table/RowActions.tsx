...
export function CollectionsRowActions({
  ...
  const confirmMessagesMap: Record<ActionType, ConfirmMessages> = {
    delete: {
      pending: {
        description: "آیا از حذف این کالکشن مطمئن هستید؟",
      },
      success: {
        title: "کالکشن با موفقیت حذف شد",
      },
    },
    restore: {
      pending: {
        description: "آیا مایل به بازیابی این کالکشن هستید؟",
      },
      success: {
        title: "کالکشن با موفقیت بازیابی شد",
      },
    },
    hardDelete: {
      pending: {
      ...
      success: {
        title: "کالکشن برای همیشه حذف شد",
      },
    },
  };
...
export default CollectionsRowActions;
