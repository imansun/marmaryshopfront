...
export function TagsRowActions({
  row,
  tab,
  onEdit,
  onDelete,
  ...
  const confirmMessagesMap: Record<ActionType, ConfirmMessages> = {
    delete: {
      pending: {
        description: "آیا از حذف این تگ مطمئن هستید؟",
      },
      success: {
    ...
    restore: {
      pending: {
        description: "آیا مایل به بازیابی این تگ هستید؟",
      },
      success: {
        title: "تگ با موفقیت بازیابی شد",
      },
    },
    hardDelete: {
      pending: {
